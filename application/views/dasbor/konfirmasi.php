...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<tbody>
						...
						<tr>
							...
							<td>: <?php if ($header_transaksi->bukti_bayar !="") { ?>
								<img src="<?php echo base_url('assets/upload/image/thumbs/'.$header_transaksi->bukti_bayar) ?>" class="img img-thumbnail" width="200">
				...
				<table class="table">
					<tbody>
						...
						<tr>
							<td>Tanggal Bayar</td>
							<td>
								<input type="text" name="tanggal_bayar" class="form-control-lg" placeholder="dd-mm-yyyy" value="<?php if(isset($_POST['tanggal_bayar'])) { echo set_value('tanggal_bayar');
				...
				// kalau ga ada tampilkan notifkasi
				}else{ ?>
